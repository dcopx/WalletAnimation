    ...
    Canvas(modifier = Modifier.fillMaxWidth().height(250.dp)) {
        ...
        drawPath(
            ...
            brush = Brush.verticalGradient(
                colors = listOf(ColorSpaceStart.copy(0.6f), Color.Transparent),
                startY = height * 0.1f,
                endY = height
            ),
        ...
        drawPath(
            ...
            brush = Brush.radialGradient(
                colors = listOf(Color.Transparent, ColorSpaceStart.copy(0.4f)),
        ...
        Row(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Box(
                    modifier = Modifier
                        .size(20.dp)
                        .background(ColorPlatinumBase, CircleShape)
                )
                Spacer(Modifier.width(8.dp))
                Text(
                    "NEXUS",
                    color = ColorPlatinumBase,
                    fontSize = 22.sp,
