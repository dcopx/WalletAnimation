...
val ColorSpaceStart = Color(0xFF1E1B4B)
val ColorSpaceEnd = Color(0xFF020617)
val ColorTextPrimary = Color(0xFFF8FAFC)
val ColorTextSecondary = Color(0xFF94A3B8)
val ColorPlatinumBase = Color(0xFFE2E8F0)
val ColorPlatinumDark = Color(0xFFCBD5E1)
val ColorElectricAccent = Color(0xFF6366F1)
val ColorSilverText = Color(0xFF9CA3AF)

val SpecularWhite = Color(0xFFFFFFFF).copy(alpha = 0.8f)
val ColorGlassSurface = Color(0xFFFFFFFF).copy(alpha = 0.05f)

val ColorGreenIn = Color(0xFF22C55E)
val ColorRedOut = Color(0xFFEF4444)
val ColorPurpleIridescent = Color(0xFF818CF8)
val ColorVioletIridescent = Color(0xFFC084FC)
val ColorWhiteIridescent = Color(0xFFFFFFFF)
...
val ColorIridescentBorder = Brush.linearGradient(
    colors = listOf(
        ColorPurpleIridescent.copy(alpha = 0.5f),
        ColorVioletIridescent.copy(alpha = 0.3f),
        ColorWhiteIridescent.copy(alpha = 0.1f)
    )
)
